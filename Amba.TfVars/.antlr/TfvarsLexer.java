...
public class TfvarsLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"VARIABLE", "IN", "STAR", "DOT", "LCURL", "RCURL", "LPAREN", "RPAREN", 
			"EOF_", "NULL_", "NATURAL_NUMBER", "BOOL", "DESCRIPTION", "MULTILINESTRING", 
			"STRING", "IDENTIFIER", "COMMENT", "BLOCKCOMMENT", "WS"
		};
	}
	...
	public TfvarsLexer(CharStream input) {
		super(input);
